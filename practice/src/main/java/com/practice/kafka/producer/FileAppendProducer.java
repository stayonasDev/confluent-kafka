...
public class FileAppendProducer {
    ...
    private final static Logger log = LoggerFactory.getLogger(FileAppendProducer.class);
    ...
    public static void main(String[] args) {
        ...
        File file = new File("D:\\PorjectFile\\KafkaProject-01\\practice\\src\\main\\resources\\pizza_append.txt");

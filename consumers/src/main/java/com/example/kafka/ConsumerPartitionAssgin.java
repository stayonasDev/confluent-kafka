...
public class ConsumerPartitionAssgin {

    private static final Logger log = LoggerFactory.getLogger(ConsumerPartitionAssgin.class);
    ...
    public static void main(String[] args) {
        ...
        props.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "group_pizza_assgin_seek");

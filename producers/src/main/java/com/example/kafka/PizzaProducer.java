    ...
    public static void sendPizzaMessage(KafkaProducer<String, String> kafkaProducer,
        ...
        while (iterSeq != iterCount) {
            ...
            if(interIntervalMillis > 0) {
                try {
                    log.info("intervalMillis:" + interIntervalMillis);
    ...
    public static void sendMessage(KafkaProducer<String, String> kafkaProducer,
        ...
        if (!sync) {
            kafkaProducer.send(producerRecord, (metadata, exception) -> {
                if (exception == null) {
                    log.info("async message:" + pMessage.get("key") + "partitions:" + metadata.partition() +
            ...
            try {
                ...
                log.info("sync message: " + pMessage.get("key") +  "partitions:" + recordMetadata.partition() + "\n" +
